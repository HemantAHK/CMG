...
void R_WdivZ(TString folder="", int OnlyCounts=0, int tot_N_evts=1, int generated_PDF_set=1, int generated_PDF_member=0){
  ...
  TString Wana_str[CutSteps]    ={"hWPos_PtScaled_1_Gen","hWPos_PtScaled_2_ZGenMassCut","hWPos_PtScaled_3_Mu1GenCut","hWPos_PtScaled_4_Mu2GenCut",
    "hWPos_PtScaled_5_RecoCut","hWPos_PtScaled_6_METCut","hWPos_PtScaled_7_RecoilCut",Form("hWPos_PtScaled_8_JetCut_pdf%d-%d",WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,generated_PDF_member)};
  TString Zana_str[CutSteps]    ={"hWlikePos_PtScaled_1_Gen","hWlikePos_PtScaled_2_ZGenMassCut","hWlikePos_PtScaled_3_Mu1GenCut","hWlikePos_PtScaled_4_Mu2GenCut",
    "hWlikePos_PtScaled_5_RecoCut","hWlikePos_PtScaled_6_METCut","hWlikePos_PtScaled_7_RecoilCut",Form("hWlikePos_PtScaled_8_JetCut_pdf%d-%d",WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,generated_PDF_member)};
  ...
  for(int i=0; i<WMass::etaMuonNSteps; i++){
    ...
    for(int j=0; j<2*WMass::WMassNSteps+1; j++){
      ...
      TH1D*hWPos_NonPtScaled=(TH1D*)Wana->Get(Form("hWPos_PtNonScaled_8_JetCut_pdf%d-%d_eta%s_%d",WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,generated_PDF_member,eta_str.Data(),jWmass));
      TH1D*hWlikePos_NonPtScaled=(TH1D*)Zana->Get(Form("hWlikePos_PtNonScaled_8_JetCut_pdf%d-%d_eta%s_%d",WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,generated_PDF_member,eta_str.Data(),jWmass));
      if(!OnlyCounts){
