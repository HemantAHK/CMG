...
#ifndef Wanalysis_controlplots_h
#define Wanalysis_controlplots_h
...
class Wanalysis_controlplots {
  ...
  Wanalysis_controlplots(TString f_str=0, double lumi_scaling_input=1, int useGen=0, TTree *tree=0);
  virtual ~Wanalysis_controlplots();
...
#ifdef Wanalysis_controlplots_cxx
Wanalysis_controlplots::Wanalysis_controlplots(TString f_str, double lumi_scaling_input, int useGen, TTree *tree)
{
...
Wanalysis_controlplots::~Wanalysis_controlplots()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t Wanalysis_controlplots::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t Wanalysis_controlplots::LoadTree(Long64_t entry)
{
...
void Wanalysis_controlplots::Init(TTree *tree)
{
...
Bool_t Wanalysis_controlplots::Notify()
{
...
void Wanalysis_controlplots::Show(Long64_t entry)
{
...
Int_t Wanalysis_controlplots::Cut(Long64_t entry)
{
...
#endif // #ifdef Wanalysis_controlplots_cxx
