...
runWanalysis_controlplots = 1; # perform the analysis on W control plots
runZanalysis_controlplots = 0; # perform the analysis on Z control plots
...
WMassStep_MeV = "10"; # 15
WMassNSteps = "0"; # 60
# runWanalysis_controlplots = 1; # perform the analysis on W
...
if(runWanalysis_controlplots or runZanalysis_controlplots ):
    ...
    for i in range(0, nsamples):
        ...
        if parallelize and (runWanalysis_controlplots or runZanalysis_controlplots) and counter>1:
        ...
        if(runWanalysis_controlplots):
            ...
            if(counter<2):
                if(useLHAPDF):
                    os.system("sed -i 's/.*\#define\ LHAPDF_ON.*/\#define\ LHAPDF_ON/' Wanalysis_controlplots.C")
                    print("c++ -o runWanalysis_controlplots.o `root-config --glibs --libs --cflags`  -I "+lhapdf_folder+"/include -L "+lhapdf_folder+"/lib -lLHAPDF  -lm Wanalysis_controlplots.C rochcor_44X_v3.C runWanalysis_controlplots.C")
                    os.system("rm runWanalysis_controlplots.o; c++ -o runWanalysis_controlplots.o `root-config --glibs --libs --cflags`  -I "+lhapdf_folder+"/include -L "+lhapdf_folder+"/lib -lLHAPDF  -lm Wanalysis_controlplots.C rochcor_44X_v3.C runWanalysis_controlplots.C")
                else:
                    os.system("sed -i 's/.*\#define\ LHAPDF_ON.*/\/\/\#define\ LHAPDF_ON/' Wanalysis_controlplots.C")
                    print("c++ -o runWanalysis_controlplots.o `root-config --glibs --libs --cflags` -lm Wanalysis_controlplots.C rochcor_44X_v3.C runWanalysis_controlplots.C")
                    os.system("rm runWanalysis_controlplots.o; c++ -o runWanalysis_controlplots.o `root-config --glibs --libs --cflags`  -lm Wanalysis_controlplots.C rochcor_44X_v3.C runWanalysis_controlplots.C")
            
            # print("root -l -b -q \'runWanalysis_controlplots2.cpp("+wstring+")\'");
            
            # os.system("root -l -b -q \'runWanalysis_controlplots2.cpp("+wstring+")\'");
            print " "
            # print wstring
            if not parallelize:
                os.system("./runWanalysis_controlplots.o "+wstring)
                # os.system("root -l -b -q \'runWanalysis_controlplots.C("+wstring+")\'");
            else:
                os.system("./runWanalysis_controlplots.o "+wstring+" > ../"+filename_outputdir+"Wlog.log 2>&1 &")
                # print "root -l -b -q \'runWanalysis_controlplots.C("+wstring+")\' ../> "+filename_outputdir+"Wlog.log 2>&1 &";
                # os.system("root -l -b -q \'runWanalysis_controlplots.C("+wstring+")\' > ../"+filename_outputdir+"Wlog.log 2>&1 &");

        if(runZanalysis_controlplots):
            ...
            if not parallelize:
                ...
                if(runWanalysis_controlplots): os.system("sleep 3");
